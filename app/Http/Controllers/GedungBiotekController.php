...
class GedungbiotekController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('admin/gedungbiotek', compact('gedungbiotek') );
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/gedungbiotek')->with('success','data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/gedungbiotek')->with('success','data berhasil diupdate');
    ...
    public function destroy($id)
    {
        ...
        $gedungbiotek = Denah::find( $id);
        if(Storage::delete($gedungbiotek->denah)) {
            $gedungbiotek->delete();
         }
        $gedungbiotek->delete();
        return redirect('/gedungbiotek')->with('success','data berhasil dihapus');
