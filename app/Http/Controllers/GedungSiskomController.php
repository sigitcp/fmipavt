...
class GedungsiskomController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('admin/gedungsiskom', compact('gedungsiskom') );
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/gedungsiskom')->with('success','data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/gedungsiskom')->with('success','data berhasil diupdate');
    ...
    public function destroy($id)
    {
        ...
        $gedungsiskom = Denah::find( $id);
        if(Storage::delete($gedungsiskom->denah)) {
            $gedungsiskom->delete();
         }
        $gedungsiskom->delete();
        return redirect('/gedungsiskom')->with('success','data berhasil dihapus');
