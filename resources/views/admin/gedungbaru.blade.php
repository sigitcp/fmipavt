...
<div class="card-body">
    ...
    <!-- ---------modalcreate------ -->
    @include('admin.modal.gedungbaru.create')
...
@foreach ($gedungbaru as $gbr)           
                <tr>
                    ...
                    <td><img src="{{ asset('storage/'. $gbr->denah) }}" width="70"></td>
                    <td>
                        ...
                        @include('admin.modal.gedungbaru.delete')
                        <button class="btn btn-primary text-info" data-toggle="modal" data-target="#modaledit{{ $gbr->id }}"><span class="fas fa-edit mr-2"></span>Edit</button>
                    </td>
                </tr>

                <!-- modal edit -->
                @include('admin.modal.gedungbaru.edit')
                @endforeach
            </tbody>
        </table>
    </div>
