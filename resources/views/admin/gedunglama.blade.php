...
<div class="card-body">
    ...
    <!-- ---------modalcreate------ -->
    @include('admin.modal.gedunglama.create')
...
@foreach ($gedunglama as $glm)           
                <tr>
                    ...
                    <td><img src="{{ asset('storage/'. $glm->denah) }}" width="70"></td>
                    <td>
                        ...
                        @include('admin.modal.gedunglama.delete')
                        <button class="btn btn-primary text-info" data-toggle="modal" data-target="#modaledit{{ $glm->id }}"><span class="fas fa-edit mr-2"></span>Edit</button>
                    </td>
                </tr>

                <!-- modal edit -->
                @include('admin.modal.gedunglama.edit')
                @endforeach
            </tbody>
        </table>
    </div>
