<div class="modal" tabindex="-1" role="dialog" id="modaledit{{ $glm->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit denah gedung lama</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('gedunglama.update',$glm['id']) }}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    ...
                    <input type="hidden" name="oldImage" value="{{$glm->denah}}">
                    <div class="form-group">
                        <img class="btn shadow-inset" src="{{ asset('storage/'. $glm->denah) }}" >
                    </div> 
                    <div class="form-group">
