<div class="modal" tabindex="-1" role="dialog" id="modaledit{{ $sis->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit denah gedung siskom</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('gedungsiskom.update',$sis['id']) }}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    ...
                    <input type="hidden" name="oldImage" value="{{$sis->denah}}">
                    <div class="form-group">
                        <img class="btn shadow-inset" src="{{ asset('storage/'. $sis->denah) }}" >
                    </div> 
                    <div class="form-group">
