<div class="modal" tabindex="-1" role="dialog" id="modaledit{{ $bio->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit denah gedung biotek</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('gedungbiotek.update',$bio['id']) }}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    ...
                    <input type="hidden" name="oldImage" value="{{$bio->denah}}">
                    <div class="form-group">
                        <img class="btn shadow-inset" src="{{ asset('storage/'. $bio->denah) }}" >
                    </div> 
                    <div class="form-group">
