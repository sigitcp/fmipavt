...
@section('container')
<div class="card-body">
    <h1 class="mt-0">Gedung Biotek</h1>
    ...
    <!-- ---------modalcreate------ -->
    @include('admin.modal.gedungbiotek.create')
...
@foreach ($gedungbiotek as $bio)           
                <tr>
                    ...
                    <td><img src="{{ asset('storage/'. $bio->denah) }}" width="70"></td>
                    <td>
                        ...
                        @include('admin.modal.gedungbiotek.delete')
                        <button class="btn btn-primary text-info" data-toggle="modal" data-target="#modaledit{{ $bio->id }}"><span class="fas fa-edit mr-2"></span>Edit</button>
                    </td>
                </tr>

                <!-- modal edit -->
                @include('admin.modal.gedungbiotek.edit')
                @endforeach
            </tbody>
        </table>
    </div>
