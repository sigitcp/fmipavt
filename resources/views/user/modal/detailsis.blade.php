            ...
            <div class="modal-body px-6">
                <div class="py-3">
                    <div class="text-center">
                        <img width="100%"
                            src="{{ asset('storage/'. $sis->denah) }}">
                        <div class="nav-wrapper position-relative">
                            <ul
                                class="nav nav-pills nav-fill flex-column flex-md-row">
                                <li class="nav-item">
                                    <span class="nav-link shadow-inset"><span>{{__('Room')}} {{$sis->nama}}
                                        </span></span>
                                </li>
                                <li class="nav-item">
                                    <span class="nav-link shadow-inset"><span>{{__('Large')}} {{$sis->luas}}
                                        </span>
                                        m<sup>2</sup></span>
                                </li>
                                <li class="nav-item">
                                    <span class="nav-link shadow-inset"><span>{{__('Capacity')}} {{$sis->kapasitas}}
                                        </span>
                                        {{__('peoples')}}</span>
                                </li>
                            </ul>
